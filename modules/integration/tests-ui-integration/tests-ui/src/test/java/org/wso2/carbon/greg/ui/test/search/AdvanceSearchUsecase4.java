...
/**
 * Use-case 4
 * This test case Search for matches containing a specific pattern or wildcard search.
 * Add two Services called myService1 and myService2.
 *      media type	= application/vnd.wso2-service+xml
 *      Indexer	= RXTIndexer
 * Search for the services
 */
public class AdvanceSearchUsecase4 extends GREGIntegrationUIBaseTest {
    ...
    public void test() throws Exception {
        ...
        driver.findElement(By.id("id_Overview_Name")).sendKeys("myService1");
        ...
        // Add service2
        driver.findElement(By.linkText("Service")).click();
        driver.findElement(By.id("id_Overview_Name")).sendKeys("myService2");
        driver.findElement(By.id("id_Overview_Namespace")).sendKeys("org.wso2.greg");
        driver.findElement(By.id("id_Overview_Version")).sendKeys("2.0.0");
        driver.findElement(By.xpath("//input[contains(@class,'button registryWriteOperation')]")).click();
        ...
        // to search.
        Thread.sleep(40000);
        // Search for services added
        driver.findElement(By.linkText("Search")).click();
        driver.findElement(By.id("#_resourceName")).sendKeys("my%");
        Thread.sleep(10000);
